...
cp mparameters_mrc mparameters_run
...
while ( $lastn <= $last )
  ...
  ${working_directory}/mrefine_n_v9_mrc.com $firstn $lastn $start &
...
echo "Calculating 3D structure...."
  ...
  ${working_directory}/mult_reconstruct_v9_mrc.com $first $last $start
